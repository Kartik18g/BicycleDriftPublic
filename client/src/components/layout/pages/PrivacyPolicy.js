    ...
    <div style={{ marginTop: "100px" }} className="container">
      ...
      <div className="section">
        ...
        <p style={{ fontSize: "1.5rem" }}>
          This website is operated by  CHAWLA TRADERS . Throughout the site, the
          terms “we”, “us” and “our” refer to CHAWLA TRADERS. CHAWLA
          TRADERS offers this website, including all information, tools and
          ...
          new features or tools which are added to the current store shall also
      ...
      <div className="section">
        ...
        <p style={{ fontSize: "1.5rem" }}>
          ...
          non-infringement. In no case shall CHAWLA TRADERS, our directors,
          ...
          harmless CHAWLA TRADERS and our parent, subsidiaries, affiliates,
