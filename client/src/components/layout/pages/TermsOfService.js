    ...
    <div style={{ marginTop: "100px" }} className="container">
      ...
      <div className="section">
        ...
        <p style={{ fontSize: "1.5rem" }}>
          ...
          contacting us at 2A/117 NIT 2 FARIDABAD, NEAR INDIA COLLEGE  or
          mailing us bicyclesdrift@gmail.com
        </p>
      </div>
      <div className="section">
      ...
      <div className="section">
        ...
        <p style={{ fontSize: "1.5rem" }}>
          ...
          you may also want to read terms and conditions of razorpay
      ...
      <div className="section">
        ...
        <p style={{ fontSize: "1.5rem" }}>
          We don't use cookies to maintain session of your user. It is not used
      ...
      <div className="section">
        ...
        <p style={{ fontSize: "1.5rem" }}>
          ...
          at bicyclesdrift@gmail.com or by mail at 2A/117 NIT 2 FARIDABAD, NEAR
          INDIA COLLEGE [Re: Privacy Compliance Officer] [622 Manglam Electronic
